...
export default function RegisterPage() {
  return (
    <main className="flex min-h-screen flex-col bg-[#05050B] text-white lg:flex-row">
      <section className="relative flex min-h-[44vh] items-center justify-center overflow-hidden bg-[#0D0B22] px-8 py-14 lg:min-h-screen lg:w-1/2 lg:basis-1/2 lg:pl-20 lg:pr-16 xl:pl-24 xl:pr-20">
      ...
      <section className="flex items-center justify-center px-8 py-14 lg:w-1/2 lg:basis-1/2 lg:pl-16 lg:pr-20 xl:pr-24">
